...
| **Registrar usuario**                                                                     | Implementar registro de usuario a través del API                                                                                                         | 4                                    | Sprint 3     |
| **Iniciar sesión de usuario**                                                             | Crear funcionalidad de inicio de sesión mediante el API                                                                                                  | 3                                    | Sprint 3     |
| **Obtener información del usuario**                                                       | Implementar endpoint para obtener información del usuario                                                                                                | 3                                    | Sprint 3     |
| **Crear registro de plantación**                                                          | Crear registro de plantación a través de API                                                                                                             | 5                                    | Sprint 3     |
| **Obtener información de la plantación**                                                  | Implementar endpoint para obtener información de la plantación                                                                                           | 4                                    | Sprint 3     |
| **Finalizar ciclo de plantación**                                                         | Función para finalizar ciclo de plantación                                                                                                               | 6                                    | Sprint 3     |
| **Registrar trabajador**                                                                  | Crear registro de trabajador a través del API                                                                                                            | 3                                    | Sprint 3     |
| **Obtener información de trabajador**                                                     | Obtener información de registro de trabajadores                                                                                                          | 3                                    | Sprint 3     |
| **Eliminar trabajador**                                                                   | Eliminar registro de trabajador a través del API                                                                                                         | 4                                    | Sprint 3     |
| **Editar trabajador**                                                                     | Implementar edición de registro de trabajador                                                                                                            | 4                                    | Sprint 3     |
| **Crear fechas de irrigación**                                                            | Crear fechas de irrigación mediante el API                                                                                                               | 5                                    | Sprint 3     |
| **Obtener fechas de irrigación**                                                          | Obtener fechas de irrigación de un campo                                                                                                                 | 3                                    | Sprint 3     |
| **Eliminar irrigación**                                                                   | Función para eliminar registros de irrigación                                                                                                            | 4                                    | Sprint 3     |
| **Crear tratamiento**                                                                     | Crear registro de tratamiento para los cultivos                                                                                                          | 6                                    | Sprint 3     |
| **Obtener tratamiento**                                                                   | Obtener información de tratamientos aplicados                                                                                                            | 3                                    | Sprint 3     |
| **Eliminar tratamiento**                                                                  | Función para eliminar tratamientos de cultivos                                                                                                           | 4                                    | Sprint 3     |
| **Crear cosecha**                                                                         | Implementar registro de cosecha a través del API                                                                                                         | 6                                    | Sprint 3     |
| **Obtener cosecha**                                                                       | Obtener información de cosechas registradas                                                                                                              | 3                                    | Sprint 3     |
| **Eliminar cosecha**                                                                      | Eliminar registros de cosechas                                                                                                                           | 4                                    | Sprint 3     |
| **Crear financiamiento**                                                                  | Crear registro de financiamiento a través del API                                                                                                        | 5                                    | Sprint 3     |
| **Obtener financiamiento**                                                                | Obtener información de financiamiento                                                                                                                    | 3                                    | Sprint 3     |
| **Eliminar financiamiento**                                                               | Función para eliminar registros de financiamiento                                                                                                        | 4                                    | Sprint 3     |
| **Procesar pagos de suscripción**                                                         | Implementar el procesamiento de pagos internamente en el sistema                                                                                         | 7                                    | Sprint 3     |
| **Crear suscripción**                                                                     | Crear suscripción a través de la API para registrarla en la base de datos                                                                                | 3                                    | Sprint 4     |
| **Obtener suscripción**                                                                   | Obtener información de la suscripción a través de la API para registrarlo en la base de datos                                                            | 2                                    | Sprint 4     |
| **Renovar suscripción**                                                                   | Renovar la suscripción a través de la API                                                                                                                | 3                                    | Sprint 4     |
| **Actualizar plan de suscripción**                                                        | Actualizar el plan de suscripción a través de la API                                                                                                     | 3                                    | Sprint 4     |
| **Crear API Fake**                                                                        | Crear una API fake para poder avanzar el desarrollo de la web app                                                                                        | 2                                    | Sprint 4     |
