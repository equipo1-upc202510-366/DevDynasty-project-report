...
![Lean UX](assets/img/chapter-1/img-lean-ux.png)
...
| **Crear campo a través de la API RESTful**                                                  | Como desarrollador, quiero crear un campo a través de la API para registrarlo en la base de datos.                                                                        | 3                                | Sprint 2 |
| **Obtener información del campo a través de la API RESTful**                                | Como desarrollador, quiero obtener la información del campo a través de la API para mostrar los datos en la aplicación.                                                   | 2                                | Sprint 2 |
| **Crear proceso agrícola a través de la API RESTful**                                       | Como desarrollador, quiero crear el proceso agrícola a través de la API para registrarlo en la base de datos.                                                             | 2                                | Sprint 2 |
| **Crear actividad en el proceso agrícola**                                                  | Como desarrollador, quiero crear actividades agrícolas a través de la API para registrarlas en la base de datos.                                                          | 5                                | Sprint 2 |
| **Crear recurso en la actividad agrícola**                                                  | Como desarrollador, quiero crear recursos en la actividad agrícola a través de la API para registrarlos en la base de datos.                                              | 3                                | Sprint 2 |
| **Registrar e iniciar sesión**                                                              | Como usuario, quiero tener en la app un apartado de inicio de sesión para que se guarde mi información.                                                                   | 3                                | Sprint 1 |
| **Formulario de login**                                                                     | Como usuario de la página web, quiero ingresar con mi cuenta con la cual me registré para usar las herramientas a mi disposición.                                         | 3                                | Sprint 1 |
| **Recuperar contraseñas**                                                                   | Como usuario, quiero que la aplicación tenga un apartado que me permita recuperar mi contraseña en caso de olvido para poder ingresar a mi cuenta.                        | 3                                | Sprint 1 |
| **Registrar usuario a través de la API RESTful**                                            | Como desarrollador, quiero registrar al usuario a través de la API para persistir su información en la base de datos.                                                     | 5                                | Sprint 1 |
| **Iniciar sesión del usuario a través de la API RESTful**                                   | Como desarrollador, quiero logear al usuario a través de la API para brindarle acceso a la aplicación.                                                                    | 5                                | Sprint 1 |
| **Obtener información del usuario a través de la API RESTful**                              | Como desarrollador, quiero obtener información del usuario a través de la API para mostrar los datos en la aplicación.                                                    | 2                                | Sprint 1 |
...
| **Eliminar información del campo a través de la API RESTful**                               | Como desarrollador, quiero eliminar la información del campo a través de la API para eliminar los datos en la aplicación.                                                 | 3                                | Sprint 2 |
| **Editar información del campo a través de la API RESTful**                                 | Como desarrollador, quiero editar la información del campo a través de la API para modificar los datos en la aplicación.                                                  | 3                                | Sprint 2 |
| **Obtener información del proceso agrícola por campo a través de la API RESTful**           | Como desarrollador, quiero obtener la información del proceso agrícola por campo a través de la API para mostrar los datos en la aplicación.                              | 2                                | Sprint 2 |
| **Obtener información del proceso agrícola por identificador a través de la API RESTful**   | Como desarrollador, quiero obtener la información del proceso agrícola por identificador del proceso agrícola a través de la API para mostrar los datos en la aplicación. | 2                                | Sprint 2 |
| **Obtener información de la actividad agrícola a través de la API RESTful**                 | Como desarrollador, quiero obtener la información de la actividad agrícola a través de la API para mostrar los datos en la aplicación.                                    | 2                                | Sprint 2 |
| **Obtener información de la última actividad agrícola a través de la API RESTful**          | Como desarrollador, quiero obtener la información de la última actividad agrícola a través de la API para mostrar los datos en la aplicación.                             | 3                                | Sprint 2 |
| **Terminar la plantación a través de la API RESTful**                                       | Como desarrollador, quiero terminar la plantación a través de la API para actualizar los datos en la aplicación.                                                          | 3                                | Sprint 2 |
| **Programar fecha de riego de cultivos**                                                    | Como productor agrícola, quiero funcionalidades de apoyo en el riego de cultivos para mejorar el cuidado de los cultivos.                                                 | 5                                | Sprint 2 |
| **Realizar compra de productos para cultivos**                                              | Como productor agrícola, quiero realizar compras de productos para mis cultivos de manera online para optimizar mi trabajo.                                               | 5                                | Sprint 2 |
| **Programar fechas de tratamiento de cultivos**                                             | Como productor agrícola, quiero funcionalidades de apoyo en el proceso de fumigación para mejorar el cuidado de los cultivos.                                             | 5                                | Sprint 2 |
| **Gestionar el proceso de recolección de la cosecha**                                       | Como productor agrícola, quiero funcionalidades de apoyo en la recolección de la cosecha para gestionar de manera eficiente el inventario y los precios.                  | 5                                | Sprint 2 |
| **Realizar análisis financiero de los cultivos**                                            | Como productor agrícola, quiero realizar un análisis financiero para visualizar la utilidad de mi trabajo.                                                                | 5                                | Sprint 2 |
| **Editar la información de la actividad del proceso agrícola a través de la API RESTful**   | Como desarrollador, quiero editar la información de la actividad a través de la API para mostrar los datos en la aplicación.                                              | 3                                | Sprint 2 |
| **Agregar trabajador a través de la API RESTful**                                           | Como desarrollador, quiero agregar trabajador a través de la API para registrarlo en la base de datos.                                                                    | 3                                | Sprint 2 |
| **Obtener trabajadores a través de la API RESTful**                                         | Como desarrollador, quiero obtener información de los trabajadores a través de la API para registrarlo en la base de datos.                                               | 2                                | Sprint 2 |
| **Eliminar trabajador a través de la API RESTful**                                          | Como desarrollador, quiero eliminar trabajador a través de la API para eliminar los datos en la aplicación.                                                               | 3                                | Sprint 2 |
| **Agregar payment a través de la API RESTful**                                              | Como desarrollador, quiero agregar payment a través de la API para registrarlo en la base de datos.                                                                       | 3                                | Sprint 2 |
| **Obtener payment a través de la API RESTful**                                              | Como desarrollador, quiero obtener información de los payment a través de la API para registrarlo en la base de datos.                                                    | 3                                | Sprint 2 |
| **Crear financiamiento a través de la API RESTful**                                         | Como desarrollador, quiero crear datos de financiamiento a través de la API para registrarlos en la base de datos.                                                        | 3                                | Sprint 2 |
| **Obtener datos de financiamiento a través de la API RESTful**                              | Como desarrollador, quiero obtener datos de financiamiento a través de la API para mostrar los datos en la aplicación.                                                    | 2                                | Sprint 2 |
| **Crear producto a través de la API RESTful**                                               | Como desarrollador, quiero crear productos a través de la API para registrarlo en la base de datos.                                                                       | 3                                | Sprint 2 |
| **Obtener productos a través de la API RESTful**                                            | Como desarrollador, quiero obtener productos a través de la API para mostrar los datos en la aplicación.                                                                  | 2                                | Sprint 2 |
| **Obtener producto por nombre a través de la API RESTful**                                  | Como desarrollador, quiero obtener productos por nombre a través de la API para mostrar los datos en la aplicación.                                                       | 2                                | Sprint 2 |
| **Editar producto a través de la API RESTful**                                              | Como desarrollador, quiero editar la información del producto a través de la API para mostrar la modificación de datos en la aplicación.                                  | 3                                | Sprint 2 |
| **Editar cantidad del producto a través de la API RESTful**                                 | Como desarrollador, quiero editar la cantidad del producto a través de la API para mostrar la modificación de datos en la aplicación.                                     | 3                                | Sprint 2 |
| **Actualizar la información de un producto para el propietario a través de la API RESTful** | Como desarrollador, quiero actualizar la información de un producto para el propietario a través de la API para mostrar la modificación de datos en la aplicación.        | 3                                | Sprint 2 |
| **Crear suscripción a través de la API RESTful**                                            | Como desarrollador, quiero crear suscripción a través de la API para registrarlo en la base de datos.                                                                     | 3                                | Sprint 2 |
| **Obtener suscripción a través de la API RESTful**                                          | Como desarrollador, quiero obtener información de la suscripción a través de la API para registrarlo en la base de datos.                                                 | 2                                | Sprint 2 |
| **Renovar suscripción a través de la API RESTful**                                          | Como desarrollador, quiero renovar la suscripción a través de la API para mostrar la modificación de datos en la aplicación.                                              | 3                                | Sprint 2 |
| **Actualizar plan de suscripción a través de la API RESTful**                               | Como desarrollador, quiero actualizar el plan de suscripción a través de la API para mostrar la modificación de datos en la aplicación.                                   | 3                                | Sprint 2 |
| **Crear API Fake**                                                                          | Como desarrollador, quiero crear una API fake para poder avanzar el desarrollo de la web app.                                                                             | 2                                | Sprint 2 |
...
![Testing Evidence](assets/img/chapter-6/img-sprint-3-testing.png)

#### 6.2.3.5. Execution Evidence for Sprint Review

![Execution Evidence](assets/img/chapter-6/img-sprint3-%20execution-evidence.png)
